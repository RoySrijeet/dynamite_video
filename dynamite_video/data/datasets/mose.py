...
class MOSETrainingDataset(TrainingDataset):
    ...
    def __init__(self, cfg, num_samples: int):
        ...
        # video fps
        fps = cfg.DATASETS.MOSE.TRAINING.FPS
        ...
        frame_sampling_multiplicative_factor = cfg.DATASETS.MOSE.TRAINING.FRAME_SAMPLING_MULTIPLICATIVE_FACTOR
        max_num_instances = cfg.DATASETS.MOSE.TRAINING.MAX_NUM_INSTANCES
    ...
    def map_annotations(
        ...
        for seq in sequences:
            ...
            maskfiles = sorted([os.path.join(path_to_annotations, seq, file) for file in os.listdir(os.path.join(path_to_annotations, seq)) if file.endswith('png') and not file.startswith("._")])
