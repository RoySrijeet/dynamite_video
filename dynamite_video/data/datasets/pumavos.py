...
class PUMAVOSTrainingDataset(TrainingDataset):
    ...
    def __init__(self, cfg, num_samples: int):
        ...
        # video fps
        fps = cfg.DATASETS.PUMAVOS.TRAINING.FPS
        ...
        frame_sampling_multiplicative_factor = cfg.DATASETS.PUMAVOS.TRAINING.FRAME_SAMPLING_MULTIPLICATIVE_FACTOR
        max_num_instances = cfg.DATASETS.PUMAVOS.TRAINING.MAX_NUM_INSTANCES
